"""학습 후보 프레임 선별 단계를 외부에서 호출하기 위한 얇은 어댑터입니다.
...
class PipelineContext(Protocol):
    ...
    def select(self) -> None:
        """TrainingPipeline.select 메서드와 동일한 계약입니다."""
        ...


def selectFrames(pipeline: PipelineContext) -> None:
    """추출 프레임의 선명도·밝기·간격을 검사해 자동 라벨링 후보를 고릅니다.
