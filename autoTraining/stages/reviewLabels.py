"""Qwen-VL 자동 검수 단계를 외부에서 호출하기 위한 얇은 어댑터입니다.
...
class PipelineContext(Protocol):
    ...
    def review(self) -> None:
        """TrainingPipeline.review 메서드와 동일한 계약입니다."""
        ...


def reviewLabels(pipeline: PipelineContext) -> None:
    """자동 라벨을 승인, 수동 검수, 거절 상태로 분류하고 판단 기록을 남깁니다.
