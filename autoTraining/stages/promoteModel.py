"""품질 통과 모델 승격 단계를 외부에서 호출하기 위한 얇은 어댑터입니다.
...
class PipelineContext(Protocol):
    ...
    def promote(self) -> None:
        """TrainingPipeline.promote 메서드와 동일한 계약입니다."""
        ...


def promoteModel(pipeline: PipelineContext) -> None:
    """평가 기준을 통과한 후보만 백업 후 운영 후보 경로로 교체합니다.
