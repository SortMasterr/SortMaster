...
**이 문서가 네이밍 규칙의 기준입니다.** 아래 "규칙"/"예외"가 전부이고, 다른 곳에 더 자세한
원본이 있지 않습니다.

과거 계획했던 대조표 스프레드시트(`Docs/skills/naming/namingRules.xlsx`)는 **만들지 않았고
당장 필요하지도 않습니다** — 있으면 편하지만 없다고 규칙이 불완전해지진 않습니다. 만들게 되면
여기에 다시 링크하세요.
